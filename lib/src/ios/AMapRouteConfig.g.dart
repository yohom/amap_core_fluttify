...
extension AMapRouteConfig_Batch on List<AMapRouteConfig> {
  ...
  Future<List<AMapTransitStrategy>> get_transitStrategy_batch() async {
    ...
    final typedResult = (resultBatch as List).map((__result__) => AMapTransitStrategy.values[__result__]).toList();
  ...
  Future<List<AMapRouteSearchType>> get_routeType_batch() async {
    ...
    final typedResult = (resultBatch as List).map((__result__) => AMapRouteSearchType.values[__result__]).toList();
