...
extension AMapServices_Batch on List<AMapServices> {
  ...
  Future<List<AMapServices>> sharedServices_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_core_fluttify').invokeMethod('AMapServices::sharedServices_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
