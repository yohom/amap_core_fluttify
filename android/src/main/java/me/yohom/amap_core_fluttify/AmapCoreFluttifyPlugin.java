...
public class AmapCoreFluttifyPlugin implements FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware {
    ...
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "me.yohom/amap_core_fluttify");
    ...
    public void onAttachedToEngine(FlutterPluginBinding binding) {
        ...
        final MethodChannel channel = new MethodChannel(binding.getBinaryMessenger(), "me.yohom/amap_core_fluttify");
